...
def Test():
    ...
    print(RECV_SINGLETON.http_port)
    print(REPL_SINGLETON.api_url)
    print(REPL_SINGLETON.api_method)
    print(REPL_SINGLETON.fiware_service)
    print(REPL_SINGLETON.fiware_servicepath)
